...
class CSVHandler(FileSystemEventHandler):
    def __init__(self, storage: AsyncObjectStorage, source_dir: str, archive_dir: str, temp_dir: str):
    ...
    def on_created(self, event):
        ...
        if file_path.suffix.lower() == '.csv':
            asyncio.create_task(self.process_csv(file_path))
...
async def main():
    ...
    event_handler = CSVHandler(storage, source_dir, archive_dir, temp_dir)
    observer = Observer()
